...
LOOP (every 30 minutes):
  ...
  2. GET /api/tasks?assigned_to=quant-researcher&status=pending
...
new on-chain alpha signal, idle every 4h (propose hypothesis), CEO/Manager request, extreme market event

## Token Budget Per Task
- Target per task: < 800 tokens
