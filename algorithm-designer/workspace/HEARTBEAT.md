...
LOOP (every 30 minutes):
  ...
  2. GET /api/tasks?assigned_to=algorithm-designer&status=pending
...
new backtest PASS result, idle every 8h (check model decay/retrain), Manager request

## Token Budget Per Task
- Target per task: < 1500 tokens
